...
const std::string F18RotatedHybridComposition2::FUNCTION_NAME = "Rotated Hybrid Composition Function 2";
// TODO: Cambiar ruta
const std::string F18RotatedHybridComposition2::DEFAULT_FILE_DATA = "../../data/cec2005CompetitionResources/supportData/hybrid_func2_data.txt";
const std::string F18RotatedHybridComposition2::DEFAULT_FILE_MX_PREFIX = "../../data/cec2005CompetitionResources/supportData/hybrid_func2_M_D";
const std::string F18RotatedHybridComposition2::DEFAULT_FILE_MX_SUFFIX = ".txt";
 ...
 * Constructor
 */
F18RotatedHybridComposition2::F18RotatedHybridComposition2(int dimension, double bias, std::string file_data, std::string file_m)
...
std::string F18RotatedHybridComposition2::getFileMxName(std::string prefix, int dimension, std::string suffix)
{
