...
OrderCrossover::OrderCrossover(map<string, void *> parameters) : Crossover(parameters){
...
Solution ** OrderCrossover::doCrossover(double probability,Solution *parent1, Solution *parent2) {
...
void * OrderCrossover::execute(void *object) {
