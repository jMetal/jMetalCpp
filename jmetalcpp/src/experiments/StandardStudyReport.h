...
#ifndef __STANDARD_STUDY_REPORT__
#define __STANDARD_STUDY_REPORT__
...
class StandardStudyReport : public ExperimentReport { };

#endif /* __STANDARD_STUDY_REPORT__ */
