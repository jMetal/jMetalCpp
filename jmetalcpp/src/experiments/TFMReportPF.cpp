...
int main(int argc, char ** argv) {
  TFMReportPF * exp = new TFMReportPF() ;

  // Name of the experiment:
  exp->experimentName_ = "TFM";
  ...
  const char * paretoFrontFile_[] = {
      "1hsg.pf", "1hvr.pf", "1stp.pf",
      //"2cpp.pf",
      "2mcp.pf", "3ptb.pf", "4dfr.pf", "4hmg.pf"};
  ...
  exp->experimentBaseDirectory_ = "C:/Docking/" +
                                 exp->experimentName_;
