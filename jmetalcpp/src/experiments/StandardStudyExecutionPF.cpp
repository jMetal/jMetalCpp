...
#include <StandardStudyExecutionPF.h>
 ...
 */
Algorithm * StandardStudyExecutionPF::algorithmSettings(string problemName,
...
int main(int argc, char ** argv) {
  ...
  StandardStudyExecutionPF * exp = new StandardStudyExecutionPF() ;
